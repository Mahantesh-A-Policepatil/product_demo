    ...
    <div class="col-sm-8 offset-sm-2">
        ...
        <form method="post" action="{{ route('orders.update', $order->id) }}">
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="price" id='price' value={{$order->product->price}} readonly />
          </div>

          <div class="form-group">
              <label for="first_name">Product Image:</label>
              <div class="col-sm-6 product_image_div">
                  <img src="{{asset('image/').'/'.$order->product->image_path}}" alt="profile Pic" height="200" width="200" id="product_image">
              </div>
          </div>
